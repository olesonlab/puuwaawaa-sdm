...
| Sheet | Description |
|-------|-------------|
| `paddock_data` | Paddock areas, elevations, and per-paddock per-alternative costs |
| `native_rareplants` | T&E plant counts and native cover percentage per paddock |
| `People` | Expert-elicited community interest base scores (rancher, hunter, recreationist) per alternative |
| `flammability` | Current and post-management Q3 fire probability per paddock per alternative |
| `Decision_table` | Alternative definitions and shared landscape costs |
...
Community interest scores were expert-elicited from DOFAW managers
